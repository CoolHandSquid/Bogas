...
ipaddr  = raw_input("What is the ip of the machine you are trying to break\n> ")
portnum = raw_input("What is the port number of the application you are trying to fuzz?\n> ")
portnum = int(portnum)
...
while True:
	...
	yorn	= raw_input("Would you like to do another conversion? (y/n)\n> ")
	if yorn	== "y":
		continue
	else:
		quit()
